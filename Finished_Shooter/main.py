...
background = pg.image.load(path.join(background_folder,"starfield.png")).convert()
background = pg.transform.scale(background,(WIDTH,HEIGHT))
background_rect = background.get_rect()
#player img loaded
player_img = pg.image.load(path.join(player_imgs_folder,"player1Ship.png")).convert()
npc_img = pg.image.load(path.join(enemy_imgs_folder,"meteorBrown_big1.png")).convert()
bullet_img = pg.image.load(path.join(player_imgs_folder,"bullet_img.png")).convert()
explosion_anim = {}
explosion_anim["lg"] =[]
explosion_anim["sm"] = []
